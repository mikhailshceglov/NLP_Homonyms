...
opencorpora_dict_path = "../data/dict.opcorpora.xml"
...
input_text = "Природа не храм, а мастерская, и человек в ней работник"
input_text = "Если бы все сражались только по своим убеждениям, войны бы не было"
input_text = "Было весело. Был долго в отсылке. Жили были. Прибыл из дальнего плавания"
input_text = "босс кфс рофлит с семинара"
input_text = "Природа не храм, а мастерская, и человек в ней работник"
input_text = "Варкалось. Хливкие шорьки Пырялись по наве, И хрюкотали зелюки, Как мюмзики в мове."

input_text = "Бабушка печет пирожки. Очень горячая печь!"
