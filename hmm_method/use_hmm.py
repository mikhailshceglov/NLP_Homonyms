...
def main():
    dictionary_path = "../data/dict.opcorpora.xml"
    ...
    input_text = "Мой дядя самых честных правил, Когда не в шутку занемог, Он уважать себя заставил И лучше выдумать не мог."
    input_text = "Как только коса коса косу, коса улыбнулась: коса была крепка, а её коса – длинна, хоть коса и не любила косо смотреть на косу"

    input_text = "Где хохлатые хохотушки хохотом хохотали и кричали турке, который начерно обкурен трубкой: «Не кури турка трубку, купи лучше ки́пу пик, лучше пик ки́пу купи», а то придёт бомбарди́р из Бра́нденбурга — бомбами забомбардиру́ет за то, что некто чернорылый у него полдвора рылом изрыл, вырыл и подрыл."
